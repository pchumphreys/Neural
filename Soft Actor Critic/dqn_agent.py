...
class DQN_agent(Base_Agent):
	...
	def __init__(self,n_inputs,n_outputs,**params):
		...
		self.rb = Replay_Buffer(self.n_inputs,self.n_outputs,discrete_action=True,**params['replay_buffer'])
	
		self.optimizer = tf.train.AdamOptimizer(learning_rate = self.lr)
		
		self.train_ops = []
		self._init_qnet_training_op()
		self._init_target_qnet_update()
	...
	def _init_target_qnet_update(self):
